--shawzin_macro_mix.lua
--"The Shawzin is my new favorite part of Warframe"
--plays various music depending on shift.ctrl/alt + mouseG6
...
function play_lshift_1()
    Sleep(0*n)
    qtabn(1)
    switch_mouse(0, 1)
    Sleep(1)
    PressAndReleaseKey("2")  --A4
    Sleep(1)
    switch_mouse(1, 3)
    Sleep(1)
    PressAndReleaseKey("1")  --A5
    Sleep(1)
    Sleep(0.0625*n)
    switch_mouse(3, 1)
    Sleep(1)
...
-- Rachmaninoff op. 23 no. 5 Ending
function play_lshift_2()
    -- Sleep(0*n)
    -- switch_mouse(0, 1)
    -- Sleep(1)
    -- PressAndReleaseKey("1")  --G4
...
-- Bach Fugue No 2 in Cm
function play_lctrl_1()
    Sleep(0*n)
    switch_mouse(0, 1)
    Sleep(1)
    PressAndReleaseKey("3")  --C5
...
-- Bach Fugue No 2 in Cm pt. 2
function play_lctrl_2()
    Sleep(1)
    switch_mouse(0, 2)
    Sleep(1)
    PressAndReleaseKey("1")  --E-5
...
-- Bach Fugue No 2 in Cm pt. 3
function play_lctrl_3()
    Sleep(0*n)
    qtabn(1)
    Sleep(1)
    PressAndReleaseKey("2")  --D4
...
function play_rshift_1()
    ...
    Sleep(1)
    Sleep(0.0625*n)
    qtabn(1)  -- TODO correct this number
    Sleep(1)
    PressAndReleaseKey("1")  --E5
    Sleep(1)
    Sleep(0.0625*n)
